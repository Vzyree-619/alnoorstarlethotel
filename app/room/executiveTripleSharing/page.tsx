...
const rightImages = [
  {
    image: '/executiveTripleSharing/img1.png',
  },
  {
    image: '/executiveTripleSharing/img2.png',
  },
];

const leftImages = [
  {
    image: '/executiveTripleSharing/img3.png',
  },
  {
    image: '/executiveTripleSharing/img4.png',
  },
];
export default function roomSuit() {
  return (
    <>
      <RoomSuit
        images='/executiveTripleSharing/img5.png'
        rightImages={rightImages}
        leftImages={leftImages}
        para='Here are some pictures of Executive Triple Sharing!'
        mainTitle='Executive Triple Sharing'
        price='21,000'
      />
