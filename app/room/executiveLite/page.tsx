...
const rightImages = [
  {
    image: '/executiveLiteImg/img1.png',
  },
  {
    image: '/executiveLiteImg/img2.png',
  },
];

const leftImages = [
  {
    image: '/executiveLiteImg/img3.png',
  },
  {
    image: '/executiveLiteImg/img4.png',
  },
];
export default function roomSuit() {
  return (
    <>
      <RoomSuit
        images='/executiveLiteImg/img5.png'
        rightImages={rightImages}
        leftImages={leftImages}
        para='Here are some pictures of Executive Lite!'
        mainTitle='Executive Lite'
        price='28,000'
      />
