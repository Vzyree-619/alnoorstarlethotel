...
const rightImages = [
  {
    image: '/deluxe/img1.png',
  },
  {
    image: '/deluxe/img2.png',
  },
];

const leftImages = [
  {
    image: '/deluxe/img3.png',
  },
  {
    image: '/deluxe/img4.png',
  },
];
export default function roomSuit() {
  return (
    <>
      <RoomSuit
        images='/deluxe/img5.png'
        rightImages={rightImages}
        leftImages={leftImages}
        para='Here are some pictures of Deluxe Room!'
        mainTitle='Deluxe Room'
        price='13,000'
      />
