...
const rightImages = [
  {
    image: '/executiveSuiteImg/img1.png',
  },
  {
    image: '/executiveSuiteImg/img2.png',
  },
];

const leftImages = [
  {
    image: '/executiveSuiteImg/img3.png',
  },
  {
    image: '/executiveSuiteImg/img4.png',
  },
];
export default function roomSuit() {
  return (
    <>
      <RoomSuit
        images='/executiveSuiteImg/img5.png'
        rightImages={rightImages}
        leftImages={leftImages}
        para='Here are some pictures of Executive Suite!'
        mainTitle='Executive Suite'
        price='28,000'
      />
