...
const rightImages = [
  {
    image: '/executiveKing/img1.png',
  },
  {
    image: '/executiveKing/img2.png',
  },
];

const leftImages = [
  {
    image: '/executiveKing/img3.png',
  },
  {
    image: '/executiveKing/img4.png',
  },
];
export default function roomSuit() {
  return (
    <>
      <RoomSuit
        images='/executiveKing/img5.png'
        rightImages={rightImages}
        leftImages={leftImages}
        para='Here are some pictures of Executive King!'
        mainTitle='Executive King'
        price='20,000'
      />
