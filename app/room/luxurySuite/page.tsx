...
const rightImages = [
  {
    image: '/luxurySuiteImg/img1.png',
  },
  {
    image: '/luxurySuiteImg/img2.png',
  },
];
...
export default function roomSuit() {
  return (
    <>
      <RoomSuit
        images='/luxurySuiteImg/img5.png'
        rightImages={rightImages}
        leftImages={leftImages}
        para='Here are some pictures of Luxury Suite!'
        mainTitle='Luxury Suite'
        price='28,000'
      />
